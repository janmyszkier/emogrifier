...
class CssInlinerTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     */
    public function cssAnimationCanBeParsed()
    {
        $cssAnimationDeclaration = '@-webkit-keyframes bounceIn {
  from, 20%, 40%, 60%, 80%, to {
  ...
  to {
    ...
    transform: scale3d(1, 1, 1);
        ...
        $subject->inlineCss( $cssAnimationDeclaration);

        self::assertNotContainsCss($cssAnimationDeclaration, $subject->render());
    }
}
